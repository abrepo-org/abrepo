...
ActiveRecord::Schema.define(version: 2022_08_24_200340) do
  ...
  create_table "diffs", force: :cascade do |t|
    ...
    t.string "group_id"
    t.string "viewMode"
    t.string "summary_added_format"
    t.string "summary_removed_format"
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.string "logo_url"
    t.string "description_source_name"
    t.string "description_source_url"
  end
