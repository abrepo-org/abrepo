...
# override docker container run.sh
#
# pgrestore: need to add recovery.signal for restore, container
# automatically removes it
# only needed to override for restore operation
